...
class NewProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create new_product" do
    assert_difference('NewProduct.count') do
      post new_products_url, params: { new_product: { author: @new_product.author, title: @new_product.title } }
    end
  ...
  test "should update new_product" do
    patch new_product_url(@new_product), params: { new_product: { author: @new_product.author, title: @new_product.title } }
